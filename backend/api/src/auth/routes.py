...
from api.src.auth.service import (
    authenticate_user,
    blacklist_token,
    create_access_token,
...
async def register(
    ...
    # Commit the user to database before queuing async tasks
    # This ensures the user exists when Celery worker tries to create email_log
    await db.commit()
