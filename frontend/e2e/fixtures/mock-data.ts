...
export const MOCK_PROJECT_DEPLOYED = {
  ...
  status: "deployed",
  deployed_url: "https://my-faq-bot.up.railway.app",
...
export const MOCK_DEPLOYMENT_INFO = {
  deploy_id: "deploy-1",
  status: "deployed",
  url: "https://my-faq-bot.up.railway.app",
  deployed_at: "2026-02-08T10:10:00Z",
}
...
export const WS_DEPLOY_MESSAGES = [
  ...
  { type: "deploy_complete", project_id: "proj-1", url: "https://my-faq-bot.up.railway.app" },
]
