import { AuthDecorativePanel } from "@/features/auth/components/auth-decorative-panel"
  ...
  return (
    <AuthGuard>
      <div className="min-h-dvh flex">
        ...
        <main className="flex-1 flex items-start md:items-center justify-center p-6 md:p-12 overflow-y-auto">
