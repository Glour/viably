/**
 * Pre-generated shadcn/ui components for WebContainer preview.
 * These files are mounted into the virtual filesystem of each preview session.
 * Paths are relative to src/ directory in the WebContainer.
 *
 * Adaptations applied to all components:
 * - Removed "use client" directives (not needed in Vite projects)
 * - Replaced @/ path aliases with relative paths
 * - Replaced @/shared/lib/utils with ../../lib/utils
 * - Replaced @/shared/ui/button with ./button
...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[10px] text-sm font-medium transition-all duration-200 ease-out disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-[3px] focus-visible:ring-primary/15 px-5 py-2.5 cursor-pointer",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-sm hover:-translate-y-[1px] hover:shadow-md active:translate-y-0 active:shadow-sm",
        destructive: "bg-destructive text-white hover:bg-destructive/90",
        outline: "border border-[var(--border)] bg-transparent hover:bg-accent hover:text-accent-foreground",
        secondary: "border border-[var(--border)] bg-transparent hover:bg-accent text-foreground",
        ghost: "bg-transparent hover:bg-primary/8 text-foreground",
...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground flex flex-col gap-6 rounded-2xl border py-6 shadow-sm relative overflow-visible transition-all duration-400 ease-[cubic-bezier(0.4,0,0.2,1)] hover:-translate-y-1 hover:shadow-lg hover:border-primary/20 before:absolute before:inset-x-0 before:top-0 before:h-0.5 before:bg-gradient-to-r before:from-[#7C3AED] before:to-[#3B82F6] before:opacity-0 before:transition-opacity before:duration-400 hover:before:opacity-100 before:rounded-t-2xl",
        className
      )}
      {...props}
    />
...
`,
  ...
  'components/ui/tooltip.tsx': `import * as React from "react"
...
`,
  ...
  'components/ui/dropdown-menu.tsx': `import * as React from "react"
