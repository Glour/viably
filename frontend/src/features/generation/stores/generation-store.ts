...
const DEFAULT_DEPLOYMENT_STEPS: DeploymentStep[] = [
  { id: "validate", name: "Валидация проекта", status: "pending", duration: null },
  { id: "prepare", name: "Подготовка файлов", status: "pending", duration: null },
  { id: "build", name: "Сборка Docker-образа", status: "pending", duration: null },
  { id: "start", name: "Запуск контейнера", status: "pending", duration: null },
  { id: "health", name: "Проверка работоспособности", status: "pending", duration: null },
  { id: "finalize", name: "Финализация", status: "pending", duration: null },
]
