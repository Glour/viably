...
export function PasswordStrength({ password }: PasswordStrengthProps) {
  ...
  const getLevel = (
    ...
    switch (score) {
      ...
      case 1:
        return { name: "Weak", color: "bg-red-500", textColor: "text-red-500" }
      case 2:
        return { name: "Fair", color: "bg-orange-500", textColor: "text-orange-500" }
      case 3:
        return { name: "Good", color: "bg-yellow-500", textColor: "text-yellow-500" }
      case 4:
        return { name: "Strong", color: "bg-green-500", textColor: "text-green-500" }
      default:
        return { name: "", color: "bg-muted", textColor: "text-muted-foreground" }
    }
  }
  ...
  return (
    <div className="space-y-2">
      ...
      <div
        ...
        role="meter"
        aria-label={`Password strength: ${level.name || "None"}`}
        aria-valuemin={0}
        aria-valuemax={4}
        aria-valuenow={score}
      >
