...
- [x] T013 [US1] Update trigger_generation() in backend/app/projects/service.py to check credits and call deduct_credits() before setting status=generating [EXECUTOR: api-builder] [SEQUENTIAL]
  → Artifacts: [service.py](../../backend/app/projects/service.py), [test_projects.py](../../backend/tests/test_projects.py)
- [x] T014 [US1] Add logging throughout AIGenerationService with structured logging format in backend/app/ai/service.py [EXECUTOR: api-builder] [SEQUENTIAL]
  → Artifacts: [service.py](../../backend/app/ai/service.py) (included in T012)
